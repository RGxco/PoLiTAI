 ...
 * 
 * Features:
 * - Frosted glass effect for AI bubbles (background blur, not text blur)
...
class ChatAdapter(
    ...
    companion object {
        ...
        private val USER_GRADIENT_START = Color.parseColor("#7C3AED") // Purple 600
        private val USER_GRADIENT_END = Color.parseColor("#4F46E5")   // Indigo 600
        
        // Text colors
        private val AI_TEXT_COLOR = Color.parseColor("#1F2937") // Gray 800
        private val USER_TEXT_COLOR = Color.WHITE
        private val TIMESTAMP_COLOR = Color.parseColor("#9CA3AF") // Gray 400
    }
    ...
    override fun onBindViewHolder(holder: MessageViewHolder, position: Int) {
        ...
        if (message.isUser) {
            ...
            // AI message styling with glassmorphism
    ...
    private fun setupUserBubble(holder: MessageViewHolder) {
        // Create gradient drawable for user bubble
    ...
    private fun setupAIBubble(holder: MessageViewHolder) {
        // Frosted glass effect for AI bubble
        ...
        holder.cardView.apply {
            ...
            // Apply blur effect to background only (Android 12+)
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
                // Create blur effect for the card background
        ...
        holder.messageText.apply {
            ...
            textSize = 15f
            setLineSpacing(4f, 1.2f)
            // CRITICAL: No blur on text - ensure crisp rendering
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
